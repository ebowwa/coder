...
console.log("\n1. Tool Usage Counts:");
console.log("-".repeat(60));
const counts = native.count_tool_use(messages);
console.table(counts);

// Test 2: Find adjacent tool pairs
console.log("\n2. Adjacent Tool Pairs (window_size=1):");
console.log("-".repeat(60));
const pairs = native.find_tool_pairs(messages, 1) as ToolPairs;
...
console.log("-".repeat(60));
const patterns = native.find_common_patterns(messages);
