/**
 * ChatUI - Terminal chat interface built on @ebowwa/tui-core
 *
...
export interface ChatUIHandle {
  rerender: (props: Partial<ChatUIProps>) => void;
  unmount: () => void;
...
function ChatUI(props: ChatUIProps): React.ReactElement {
  return (
    <App>
      <ChatUIContent {...props} />
    </App>
